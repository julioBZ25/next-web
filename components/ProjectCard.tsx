...
const ProjectCard = ({backgroundImg, description, projectUrl, color, children}: Props) => {
  return (
    <div className='max-w-[371px] h-[281px] rounded-xl bg-white relative'>
      ...
      <div className='bg-white rounded-xl px-6 py-[10px] flex flex-col h-[140px] justify-around'>
        ...
        <Link href={projectUrl}>
          <button className='rounded-xl bg-[#5651E5] px-3 py-2 text-white cursor-pointer hover:bg-[#3D37DF] active:bg-[#5651E5] active:border-[#0E0C58] active:border'>View-project</button>
        </Link>
      </div>
    </div>
  )
